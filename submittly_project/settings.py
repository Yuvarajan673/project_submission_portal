"""
Django settings for submittly_project project.
...
AUTH_USER_MODEL = 'submittly.User'
...
ROOT_URLCONF = 'submittly_project.urls'
...
WSGI_APPLICATION = 'submittly_project.wsgi.application'
